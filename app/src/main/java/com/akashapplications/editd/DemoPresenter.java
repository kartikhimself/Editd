...
import com.akashapplications.editd.Utils.OpenFileLocation;
import com.akashapplications.editd.widget.FilterItem;
import com.akashapplications.editd.widget.FilterType;
...
public class DemoPresenter implements MovieFilterView.FilterCallback, IMovieTimer.MovieListener, MovieTransferView.TransferCallback {
    ...
    Context context;
    public DemoPresenter(Context movieMaker) {
        context = movieMaker;
    }
    ...
    public void saveVideo() {
        ...
        recorder.startRecord(new GLMovieRecorder.OnRecordListener() {
            ...
            public void onRecordFinish(boolean success) {
                ...
                dialog.dismiss();
                if (success) {
//                    Uri uri = FileProvider.getUriForFile(context, context.getResources().getString(R.string.file_provider_authorities), outputFile);
    ...
    private File initVideoFile() {
        ...
        String destinationFilename = imagesSubFolder.getAbsolutePath() + File.separatorChar+"Vid_"+String.format("photo_movie_%s.mp4",
